...
class MkTheme extends InheritedWidget {
  ...
  TextStyle get smallBtn => smallMedium.copyWith(color: MkColors.accent);
  ...
  TextStyle get body3Semi => body3.copyWith(fontWeight: MkStyle.semibold);
  TextStyle get body3Bold => body3.copyWith(fontWeight: MkStyle.bold);
  ...
  TextStyle get subhead1Semi => subhead1.copyWith(fontWeight: MkStyle.semibold);
  TextStyle get subhead1Bold => subhead1.copyWith(fontWeight: MkStyle.bold);
  TextStyle get subhead1Light => subhead1.copyWith(fontWeight: MkStyle.light);
  TextStyle get subhead2 => _text14Style;
  TextStyle get subhead2Semi => subhead2.copyWith(fontWeight: MkStyle.semibold);
  TextStyle get subhead3 => _text16Style;
  TextStyle get subhead3Semi => subhead3.copyWith(fontWeight: MkStyle.semibold);
  TextStyle get subhead3Light => subhead3.copyWith(fontWeight: MkStyle.light);
  TextStyle get subhead3Medium => subhead3.copyWith(fontWeight: MkStyle.medium);
  TextStyle get subhead4 => _text18Style;
  TextStyle get subhead4Semi => subhead4.copyWith(fontWeight: MkStyle.semibold);
  ...
  TextStyle get display1Medium => display1.copyWith(fontWeight: MkStyle.medium);
  TextStyle get display1Bold => display1.copyWith(fontWeight: MkStyle.bold);
  ...
  TextStyle get display4Semi => display4.copyWith(fontWeight: MkStyle.semibold);
