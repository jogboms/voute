...
class _$UserModel extends UserModel {
  ...
  _$UserModel._(
    ...
    if (phone == null) {
      throw new BuiltValueNullFieldError('UserModel', 'phone');
    }
    if (name == null) {
      throw new BuiltValueNullFieldError('UserModel', 'name');
    }
    if (createdAt == null) {
      throw new BuiltValueNullFieldError('UserModel', 'createdAt');
    }
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc($jc(0, id.hashCode), email.hashCode), phone.hashCode),
                name.hashCode),
            createdAt.hashCode),
        updatedAt.hashCode));
  }
