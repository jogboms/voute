...
install_android_mock:
	flutter build apk -t lib/main_mock.dart && flutter install -d 2a71eab236027ece

install_ios_mock:
	flutter build ios -t lib/main_mock.dart && flutter install -d aa61c6e8701a763b7aa199eea33bbc5bb708b039
